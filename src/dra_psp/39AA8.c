...
INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", PlayAnimation);
...
void func_8010E168(s32 arg0, s16 arg1) {
    if (arg0 == 0) {
        ...
        if (g_Player.timers[ALU_T_INVINCIBLE] <= arg1) {
            g_Player.timers[ALU_T_INVINCIBLE] = arg1;
        }
    } else if (g_Player.timers[ALU_T_INVINCIBLE_CONSUMABLES] <= arg1) {
        g_Player.timers[ALU_T_INVINCIBLE_CONSUMABLES] = arg1;
    }
}
...
INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_09117C00);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_09118330);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_09118408);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_091187D8);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_091190E0);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_09119950);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_09119D00);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_0911A0B8);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_0911ABF8);

INCLUDE_ASM("dra_psp/psp/dra_psp/39AA8", func_psp_0911B630);
