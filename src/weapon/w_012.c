...
static u16 D_58000_8017A2B0[N_ARRAY_PAL][COLORS_PER_PAL] = {
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xE670,
     0xDDEE, 0xD58C, 0xC54A, 0xB508, 0xA8C6, 0x9884, 0x8C42},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xCD2B,
     0xD58C, 0xDE0E, 0xE670, 0xEEF1, 0xF753, 0xFFD5, 0xFFFF},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8C42,
     0x9884, 0xA8C6, 0xB508, 0xC54A, 0xD58C, 0xDDEE, 0xE670},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8C42, 0x9884, 0xA8C6, 0xB508, 0xC54A, 0xD58C, 0xDDEE},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8C42, 0x9884, 0xA8C6, 0xB508, 0xC54A, 0xD58C},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8C42, 0x9884, 0xA8C6, 0xB508, 0xC54A},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8C42, 0x9884, 0xA8C6, 0xB508},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8C42, 0x9884, 0xA8C6},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8C42, 0x9884},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
...
static u16 D_58000_8017A3F0[N_ARRAY_PAL][COLORS_PER_PAL] = {
    ...
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xA5A8, 0xC270, 0xD7DF, 0xFFFF, 0x90C4,
     0xA5A8, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xA988, 0xC650, 0xD7DF, 0xFFFF, 0x8000,
     0x94C4, 0xA988, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xAD68, 0xCA50, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x94A4, 0xAD68, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xB148, 0xCA30, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x98A4, 0xB148, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xB528, 0xCE10, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x9884, 0xB528, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xB908, 0xD210, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x9C84, 0xB908, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xBCE8, 0xD1F0, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x9C64, 0xBCE8},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xACA6, 0xC9CE, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0xACA6},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000}};
static u16 D_58000_8017A530[N_ARRAY_PAL][COLORS_PER_PAL] = {
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8087,
     0x84A7, 0x88C7, 0x94E7, 0x9CE7, 0x9CE7, 0x9CE7, 0x9CE7},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x810F,
     0x8D6F, 0x91AF, 0xA9CF, 0xBDEF, 0xBDEF, 0xBDEF, 0xBDEF},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8087, 0x84A7, 0x88C7, 0x94E7, 0x9CE7, 0x9CE7, 0x9CE7},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x810F, 0x8D6F, 0x91AF, 0xA9CF, 0xBDEF, 0xBDEF},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8087, 0x84A7, 0x88C7, 0x94E7, 0x9CE7},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x810F, 0x8D6F, 0x91AF, 0xA9CF},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8087, 0x84A7, 0x88C7},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x810F, 0x8D6F},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8087},
    {0x0000, 0x99A6, 0xAA0A, 0xBA6E, 0xCED3, 0xDF37, 0xEF9B, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000}};
static u16 D_58000_8017A670[N_ARRAY_PAL][COLORS_PER_PAL] = {
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xCD2B,
     0xD58C, 0xDE0E, 0xE670, 0xEEF1, 0xF753, 0xFFD5, 0xFFFF},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xD6B5,
     0xD68E, 0xCA0C, 0xC18A, 0xB928, 0xB0C7, 0xA886, 0xA085},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xD28F,
     0xC60D, 0xBD8B, 0xB529, 0xACC8, 0xA487, 0xA086, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xC20E,
     0xBDAD, 0xB54B, 0xACEA, 0xA4A9, 0xA088, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xB9CE,
     0xB56D, 0xAD0B, 0xA4AA, 0xA089, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xB18E,
     0xAD2D, 0xA4CC, 0xA08B, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xAD4E,
     0xA4CD, 0xA08C, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xA4EF,
     0xA08E, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0xA0B0,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000},
    {0x0000, 0xAD54, 0xB5D6, 0xBE58, 0xC6DB, 0xCF5D, 0xD7DF, 0xFFFF, 0x8000,
     0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000, 0x8000}};
static u16 D_58000_8017A7B0[N_ARRAY_PAL][COLORS_PER_PAL] = {
    {0x0000, 0x8821, 0x9484, 0x84C6, 0x814C, 0x9E36, 0x9EDB, 0x8C8D, 0xA174,
     0xAC85, 0xC0CC, 0xC96E, 0xD610, 0xDA93, 0xDF37, 0xEF59},
    {0x0000, 0xE040, 0xE080, 0xE0C0, 0xE100, 0xE140, 0xE180, 0xE1C0, 0xE200,
     0xE240, 0xE280, 0xE2C0, 0xE300, 0xE340, 0xE380, 0xE3C0},
    {0x0000, 0xE044, 0xE084, 0xE0C4, 0xE104, 0xE144, 0xE184, 0xE1C4, 0xE204,
     0xE244, 0xE284, 0xE2C4, 0xE304, 0xE344, 0xE384, 0xE3C4},
    {0x0000, 0xE048, 0xE088, 0xE0C8, 0xE108, 0xE148, 0xE188, 0xE1C8, 0xE208,
     0xE248, 0xE288, 0xE2C8, 0xE308, 0xE348, 0xE388, 0xE3C8},
    {0x0000, 0xE04C, 0xE08C, 0xE0CC, 0xE10C, 0xE14C, 0xE18C, 0xE1CC, 0xE20C,
     0xE24C, 0xE28C, 0xE2CC, 0xE30C, 0xE34C, 0xE38C, 0xE3CC},
    {0x0000, 0xE050, 0xE090, 0xE0D0, 0xE110, 0xE150, 0xE190, 0xE1D0, 0xE210,
     0xE250, 0xE290, 0xE2D0, 0xE310, 0xE350, 0xE390, 0xE3D0},
    {0x0000, 0xE054, 0xE094, 0xE0D4, 0xE114, 0xE154, 0xE194, 0xE1D4, 0xE214,
     0xE254, 0xE294, 0xE2D4, 0xE314, 0xE354, 0xE394, 0xE3D4},
    {0x0000, 0xE058, 0xE098, 0xE0D8, 0xE118, 0xE158, 0xE198, 0xE1D8, 0xE218,
     0xE258, 0xE298, 0xE2D8, 0xE318, 0xE358, 0xE398, 0xE3D8},
    {0x0000, 0xE05C, 0xE09C, 0xE0DC, 0xE11C, 0xE15C, 0xE19C, 0xE1DC, 0xE21C,
     0xE25C, 0xE29C, 0xE2DC, 0xE31C, 0xE35C, 0xE39C, 0xE3DC},
    {0x0000, 0x8821, 0xB5AD, 0xD6B5, 0x8148, 0x9E31, 0x801F, 0xA08C, 0xC192,
     0xA4A7, 0xB0C7, 0xBD28, 0xC98A, 0xD1CC, 0xDA4D, 0xE2D0},
    {0x0000, 0x8C25, 0x9C68, 0xA0CD, 0xAD30, 0xAD93, 0xADF6, 0xC699, 0xE800,
     0x8000, 0xA507, 0xB149, 0xBDAC, 0xCA0F, 0xD672, 0xE2D5},
    {0x0000, 0x9444, 0xC255, 0xA94B, 0xA5AD, 0x9189, 0xA316, 0xA087, 0xB509,
     0xBDAC, 0x9CE7, 0xB18C, 0xC631, 0xD6B5, 0xEB5A, 0xFFFF},
    {0x0000, 0x0421, 0x0C60, 0x08A7, 0x090B, 0x1DF4, 0x4AF9, 0x5100, 0x69E6,
     0x2316, 0x1884, 0x2D27, 0x3DAC, 0x5251, 0x5EB4, 0x6F38},
    {0x0000, 0x8000, 0x8820, 0x9041, 0x9C81, 0xA4A2, 0xB0E2, 0xB903, 0xC544,
     0xC986, 0xCDC9, 0xD60C, 0xDA4F, 0xE292, 0xE6D5, 0xEF38},
